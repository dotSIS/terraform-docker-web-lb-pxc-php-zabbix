<?php
    ...
    if(isset($_POST['softvendor']) && isset($_POST['softname'])){
        $svendor = $_POST['softvendor'];
        $sname = $_POST['softname'];
        $software = R::dispense('software');
        $software->setSoftware($svendor, $sname);
        $id = R::store($software);
        $message = "Software Successfully Saved!";
...
<body id="top">
    ...
    <!--Navigation-->
        ...
        <div class="text-container">
            <form method="POST" action="index-1-create.php">
                Software Vendor:
                <input type="text" name="softvendor" /><br/>
                Software Name:
                <input type="text" name="softname" /><br/>
