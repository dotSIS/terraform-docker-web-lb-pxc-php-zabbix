...
<body id="top">
    ...
    <!--Navigation-->
        ...
        <div class="text-container">
            <form method="POST" action="index-3-search.php">
                Software ID:
                <input type="text" name="softid"/><br/>
                <input type="submit" value="Search"/>
                <?php
                    if(isset($_POST['softid'])){
                        echo "<table id='softwares' border='1'>";
                        echo "<tr>";
                            echo "<th>Software ID</th>";
                            echo "<th>Software Vendor</th>";
                            echo "<th>Software Name</th>";
                        echo "</tr>";
                        foreach($software as $soft){
                            echo "<tr>";
                                echo "<td>" . $soft->getID() . "</td>";
                                echo "<td>" . $soft->getVendor() . "</td>";
                                echo "<td>" . $soft->getName() . "</td>";
                            echo "</tr>";
                        }
                    }
                    echo "</table>";
