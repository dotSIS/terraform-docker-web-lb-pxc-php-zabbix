...
<body id="top">
    ...
    <!--Navigation-->
        ...
        <div class="text-container">
            <form method="POST" action="index-5-update.php">
                <input type="hidden" name="softid_old" value="<?php echo $id;?>"/>
                <br/>
                Software ID:
                <input type="text" name="softid" value="<?php echo $id;?>"/>
                <br/>
                Software Vendor:
                <input type="text" name="softvendor" value="<?php echo $sv;?>"/>
                <br/>
                Software Name:
                <input type="text" name="softname" value="<?php echo $sn;?>"/>
                <br/>
                <input type="submit" value="Update"/>
            </form>
            <?php
                if(isset($_POST['softid_old'])){
                    $sid_old = $_POST['softid_old'];
                    $sid = $_POST['softid'];
                    $svendor = $_POST['softvendor'];
                    $sname = $_POST['softname'];
                    $software = R::find('software', ' id = ' . $sid_old);
                    foreach($software as $soft){
                        $soft->setSoftware($svendor, $sname);
                        $id = R::store($soft);
                        $message = "Software Successfully Updated!";
